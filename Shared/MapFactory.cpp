...
{
	ecs::Entity*	map = ObjectFactory::createObject(vectorPosition, vectorRotation, netID, ecs::Entity::MAP);

	(*map)[ecs::SCENE] = new ecs::SceneMesh(device, "", nameMesh, nodePickable::IS_PICKABLE, true, namePK3);
